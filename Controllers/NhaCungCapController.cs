...
namespace _2526_2121051489_BaiThi.Controllers
{
    public class NhaCungCapController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenNCC,MaNCC")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenNCC,MaNCC")] NhaCungCap nhaCungCap)
        {
            if (id != nhaCungCap.Id)
            {
                return NotFound();
